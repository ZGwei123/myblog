<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"E:\wamp64\www\tp5\public/../application/admin\view\tags\lst.html";i:1509279468;s:66:"E:\wamp64\www\tp5\public/../application/admin\view\common\top.html";i:1508554827;s:67:"E:\wamp64\www\tp5\public/../application/admin\view\common\left.html";i:1509274969;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
        ...
        <div class="widget">
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">Tags标签名</th>
                        ...
                        <?php if(is_array($tags) || $tags instanceof \think\Collection || $tags instanceof \think\Paginator): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                <td align="center" width="70%"><?php echo $vo['tagname']; ?></td>
                   ...
                   <div style="text-align:right;margin-top:10px"><?php echo $tags->render(); ?></div>
                </div>
                <div>
                	                </div>
            </div>
