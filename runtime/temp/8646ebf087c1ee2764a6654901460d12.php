<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wamp64\www\tp5\public/../application/admin\view\article\add.html";i:1508328689;s:66:"E:\wamp64\www\tp5\public/../application/admin\view\common\top.html";i:1508554827;s:67:"E:\wamp64\www\tp5\public/../application/admin\view\common\left.html";i:1508075890;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="title" placeholder="请输入文章标题" name="title" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="url" placeholder="请输入文章作者" name="author"  type="text">
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="url" placeholder="请输入关键字" name="keywords"  type="text">
                            </div>
                        </div>  
                        <div class="form-group">
