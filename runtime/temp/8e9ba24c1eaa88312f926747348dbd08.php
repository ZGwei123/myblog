<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"E:\wamp64\www\tp5\public/../application/index\view\search\search.html";i:1509256796;s:69:"E:\wamp64\www\tp5\public/../application/index\view\common\header.html";i:1509283056;s:68:"E:\wamp64\www\tp5\public/../application/index\view\common\right.html";i:1509243759;s:69:"E:\wamp64\www\tp5\public/../application/index\view\common\footer.html";i:1506349480;}*/ ?>
...
<link href="__STYLE__/style/bootstrap.min.css" type="text/css" rel="stylesheet">
...
<div class="position">搜索 : <span style="color:red;font-weight: bold;"><?php echo $keywords; ?></span></div>
...
<div class="overall">
	...
	<div class="left">
				...
				if(count($articles) == 0 || $articles == null){
					echo "<h3 style='text-align:center;'>暂无数据</h3>";
				}
				if(is_array($articles) || $articles instanceof \think\Collection || $articles instanceof \think\Paginator): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<div class="xnews2">
				<div class="pic"><?php if($vo['pic'] != ''): ?><a target="_self" href="<?php echo url('Article/index',array('articleid' => $vo['id'])); ?>"><?php endif; ?><img src="<?php if($vo['pic'] != ''): ?>__UPLOADS__/<?php echo $vo['pic']; else: ?>__STYLE__/images/error.png<?php endif; ?>" alt=""/></a></div>
				<div class="dec">
				<h3><a target="_self" href="<?php echo url('Article/index',array('articleid' => $vo['id'])); ?>"><?php echo $vo['title']; ?></a></h3>
				<div class="time">发布时间：<?php echo date("Y-m-d H:i:s",$vo['time']); ?></div>
				<p><?php echo $vo['synopsis']; ?></p>
				<?php if($vo['keywords'] != ''): ?>
				<div class="time">
				<?php
					$arr = explode(",",$vo['keywords']);
					foreach($arr as $key=>$value){
						echo "<a href='/tp5/public/index/Search/index.html?keywords=".$value."'>".$value."</a>";
					}
				?>  
				</div>
				<?php endif; ?>
