<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wamp64\www\tp5\public/../application/admin\view\article\lst.html";i:1508328686;s:66:"E:\wamp64\www\tp5\public/../application/admin\view\common\top.html";i:1508554827;s:67:"E:\wamp64\www\tp5\public/../application/admin\view\common\left.html";i:1509274969;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                暂无缩略图
                                <?php else: ?>
                                <img src="__UPLOADS__/<?php echo $vo['pic']; ?>" height="50px">
                                <?php endif; ?>
                                </td>
                   ...
                   <div style="text-align:right;margin-top:10px"><?php echo $article->render(); ?></div>
                </div>
                <div>
                	                </div>
            </div>
