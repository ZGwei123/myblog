<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"E:\wamp64\www\tp\public/../application/index\view\search\search.html";i:1510817227;s:68:"E:\wamp64\www\tp\public/../application/index\view\common\header.html";i:1510146938;s:67:"E:\wamp64\www\tp\public/../application/index\view\common\right.html";i:1510654986;s:68:"E:\wamp64\www\tp\public/../application/index\view\common\footer.html";i:1510745601;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<link href="__STYLE__/style/media.css" rel="stylesheet">
<link href="__STYLE__/style/about.css" rel="stylesheet">
...
<div class="ibody">
  ...
  <article>
    <div class="bloglist">
      <h3 class="about_h"><span style="color: red;font-size: 16px;">搜索</span> :<a style="font-size: 14px;" href="<?php echo url('Search/index', array('keywords' => $keywords)); ?>"><?php echo $keywords; ?></a></h3>
      <div class="bloglist">
      <?php if(is_array($articles) || $articles instanceof \think\Collection || $articles instanceof \think\Paginator): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      	<div class="newblog">
        	<ul>
         	 <h3><a href="<?php echo url('Article/index', array('articleid' => $vo['id'])); ?>"><?php echo $vo['title']; ?></a></h3>
        	  <div class="autor"><span>作者：<?php echo $vo['author']; ?></span><span>分类：[<a href="<?php echo url('Cate/index', array('cateid' => $vo['cate_id'])); ?>"><?php echo $vo['catename']; ?></a>]</span><span>浏览（<a href="<?php echo url('Article/index', array('articleid' => $vo['id'])); ?>"><?php echo $vo['click']; ?></a>）</span><span>评论（<a href="<?php echo url('Article/index', array('articleid' => $vo['id'])); ?>">
            ...
            <span class="look11"><a href="<?php echo url('Article/index', array('articleid' => $vo['id'])); ?>" target="_self" class="readmore1">全文>></a></span>       		
            </ul>
      ...
      <div class="pages">
			<div class="plist" >
				<?php if($articles != null): ?>
					<?php echo $articles->render(); endif; ?>
			</div>
	  </div>
      </div>   
    </div>
