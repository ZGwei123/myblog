<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"E:\wamp64\www\tp\public/../application/admin\view\links\lst.html";i:1508057499;s:65:"E:\wamp64\www\tp\public/../application/admin\view\common\top.html";i:1508554827;s:66:"E:\wamp64\www\tp\public/../application/admin\view\common\left.html";i:1509274969;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                <td align="center" width="15%"><?php echo $vo['title']; ?></td>
                                <td align="center" width="35$"><a href="<?php echo $vo['url']; ?>" target="_blank"><?php echo $vo['url']; ?></a></td>
                                <td align="center" width="20%">
                                    <?php if($vo['state'] == ''): ?>
                                    暂无说明
                                    <?php else: ?>
                                    <?php echo $vo['state']; endif; ?>
                                </td>
                                <td align="center" width="20%">
